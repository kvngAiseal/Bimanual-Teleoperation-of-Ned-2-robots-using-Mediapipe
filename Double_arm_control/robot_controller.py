...
class RobotController:
    def __init__(self, ip_address):
        ...
        self.ip_address = ip_address  # ### ADD THIS LINE ### Store the IP address
    ...
    def connect(self):
        ...
        # ### CHANGED ###
        print(f"Robot at {self.ip_address} connected and calibrated.")
    ...
    def start_control(self):
        ...
        if self.control_thread is None or not self.control_thread.is_alive():
            ...
            # ### CHANGED ###
            print(f"Control thread started for robot at {self.ip_address}.")
    ...
    def stop_control(self):
        ...
        # ### CHANGED ###
        print(f"Control thread stopped for robot at {self.ip_address}.")
    ...
    def go_to_sleep(self):
        ...
        # ### CHANGED ###
        print(f"Connection closed for robot at {self.ip_address}.")
    ...
    def _control_loop(self):
        ...
        while not self.stop_threads:
            ...
            if current_gesture == "Pointing" and (time.time() - last_toggle_time > 1.5):
                ...
                # ### CHANGED ###
                print(f"Robot {self.ip_address}: Switched to {current_mode} mode")
            ...
            if current_mode == MODE_ARM_CONTROL and target_pose_raw:
                ...
                try:
                    ...
                    # ### CHANGED ###
                    print(f"Robot {self.ip_address} movement error: {e}")
                ...
                if current_gesture and current_gesture != last_sent_gesture:
                    if current_gesture in ["Open Hand", "Closed Hand"]:
                        try:
                            ...
                            # ### CHANGED ###
                            print(f"Robot {self.ip_address} gripper error: {e}")
                ...
                if target_pose_raw:
                    ...
                    try:
                        ...
                        # ### CHANGED ###
                        print(f"Robot {self.ip_address} rotation error: {e}")
